...
const Home = () => {
  ...
  const benefits = [
    t('home.benefits.directConnection'),
    t('home.benefits.transparentPricing'),
    t('home.benefits.qualityGuarantee'),
    t('home.benefits.securePayments'),
    t('home.benefits.logisticsSupport'),
    t('home.benefits.multilingual')
  ];
